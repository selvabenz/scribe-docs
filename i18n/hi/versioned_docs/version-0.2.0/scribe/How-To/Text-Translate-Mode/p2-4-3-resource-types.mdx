...
-   Click on the _collection_ tab to import resources from local storage.

-   Click on _“Select Folder”_
...
(1) To download the Bible story of your choice, _RESOURCE_
...
(2) To upload resources from local, _COLLECTION_
